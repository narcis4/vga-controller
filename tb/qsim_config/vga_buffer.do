...
add wave -noupdate -radix decimal /tb_vga_buffer/col_r
add wave -noupdate -radix decimal /tb_vga_buffer/row_r
add wave -noupdate -radix decimal /tb_vga_buffer/dout
add wave -noupdate /tb_vga_buffer/wr_en
add wave -noupdate -radix decimal /tb_vga_buffer/w_addr_i
add wave -noupdate -radix binary /tb_vga_buffer/w_strb_i
add wave -noupdate /tb_vga_buffer/din
add wave -noupdate /tb_vga_buffer/dut_vga_buffer/bmem
